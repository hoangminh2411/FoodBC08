export class Menu {
    ...
    layThongTinMonAn = (maMon) => {
        ...
        //Tương tự hàm findindex => hàm find trả về đối tượng (phần tử ) trong mảng thoã điều kiện của arrow function
    ...
    capNhatMonAn = (ma, monAnCapNhat) => {
        ...
        // {maMon:3,tenMon:'goi',gia:''}
        //Tìm thấy món ăn khớp với mã trên popup 
        if(monAn) {
